...
<head>
    ...
    <script src="BJUI/CSS/js/sha256.js"></script>
    <style type="text/css">
        * {
...
$(function () {
   ...
   // LoginLoad();
	...
	$("#login_form").submit(function(){
	 ...
	 //   window.location.href = 'AdminIndexfullScreen.html'; /*注意：生产环境时请删除此行*/
        return true;
	});
});
        ...
        <div class="login_box">
           <div class="login_logo">
            ...
            <div class="login_form">
                ...
                <form action="AdminLogin.aspx" method="post" id="login_form">
